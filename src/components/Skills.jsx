  ...
  return (
    <div name="skills" className='w-full h-screen bg-gray-300 text-gray-900'>
      <div className='h-full w-full flex flex-col'>
        ...
        <ul name="nav" className='flex mt-4 justify-evenly text-lg
        ...
        <div name="page content" className='transition-opacity text-xs w-full h-full bg-pink-300'>
          <div name="general language" className={pageIndex === 0 ? "absolute duration-500 h-full" :
          " absolute duration-500 opacity-0"}>
            <div name="gen lang content" className='w-full flex flex-col justify-evenly
            bg-blue-100'>
        ...
        <div name='footer' className='w-full h-[10vh] mt-auto bg-green-200 
        flex flex-col'>
