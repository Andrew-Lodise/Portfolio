      ...
      <div className="fixed w-[100%] flex md:justify-between justify-end items-center bg-gray-900
       text-gray-300 h-[100px] border-b-[1px] border-gray-950">
        ...
        <ul className='hidden md:flex gap-x-[20px] pl-[40px] w-[40%] text-2xl '>     
            ...
            className='border-2 border-gray-300 px-[5px] cursor-pointer 
        ...
        <ul className='hidden md:flex gap-x-[20px] pr-[20px] text-[25px] '>
          <a href="https://github.com/Andrew-Lodise" target='_'
          className='border-2 border-gray-300 hover:bg-gray-300 hover:text-gray-900'>
        ...
        z-10 mr-2 hover:bg-gray-300 text-gray-300 hover:text-gray-800'
        onClick={handleBarClick}>
          <FaBars size={30}/> 
        </div>
        <ul className={!miniMenu ? 'hidden' : `absolute top-0 left-0 w-full h-screen bg-gray-900 
        flex flex-col gap-y-6 items-center justify-center duration-200 text-4xl text-gray-300`}>
            <Link to="home" spy={true} smooth={true} duration={500}
            onClick={handleBarClick} 
