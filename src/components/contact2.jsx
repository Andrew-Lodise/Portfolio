...
const contact2 = () => {
  ...
  return (
    <section name="contact" className='bg-primary w-full h-[800px] text-secondary
    flex flex-col md:px-24 px-6 py-24 items-center '>
      <div className='max-w-[1000px] w-full h-full flex flex-col items-center'>
        ...
        font-semibold max-w-[400px]'>
          ...
          py-2 duration-300 ease-in-out hover:bg-tertiary hover:text-black'
          onClick={openResume}>
            Resume
          </button>
        </div>
