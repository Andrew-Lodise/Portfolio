      ...
      <div className='mx-auto px-8 flex flex-col justify-center pt-[200px] '>
        <div className='flex flex-col items-center h-full'>
          ...
          <div className=' flex flex-col w-screen items-left'>
            <h1 className='text-[60px] md:text-[90px] lg:text-[100px] ml-[14%] md:ml-[23%] mb-[-30px]
            md:mb-[-40px] font-greatVibes text-blue-300 min-w-[500px]'>
              Andrew Lodise
            </h1>
          </div>
          
          { /* about me section */}
          <div className='flex flex-col top-[200px] items-left ml-[10%] md:ml-[20%] mr-[10%]
          md:mr-[15%] lg:py-4'>
